...
# Booka) or a cached catalog (Laguna, Vulkan, Čarobna knjiga), so search and
# the live-check page iterate this one list.
ACTIVE_CLIENTS: list[BookstoreClient] = [_laguna, _vulkan, _delfi, _booka, _carobna_knjiga]
